  ...
  return (
    ...
    <div className='flex gap-2 justify-between flex-col items-center'>
      ...
      <div className='mt-6 w-full'>
          ...
          <Link to='/captain-home' className='mt-5 w-full flex justify-center bg-emerald-600 text-white font-semibold p-2 rounded-lg'>Finish Ride</Link>
          <p className='text-red-500 mt-10 text-x5 '>Click on finish ride if you have completed the payment.</p>
      </div>
    </div>
  </div>
  )
